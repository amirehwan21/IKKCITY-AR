...
public class Loc_MasjidUMS : MonoBehaviour
{
    ...
    public static Loc_MasjidUMS Instance { set; get; }
    public float originalLatitude = 6.038324f;
    public float originalLongitude = 116.125617f;
    public float radius;
