...
public class Loc_KSA : MonoBehaviour
{
    ...
    public static Loc_KSA Instance { set; get; }
    public float originalLatitude = 6.031452f;
    public float originalLongitude = 116.143704f;
    public float radius;
