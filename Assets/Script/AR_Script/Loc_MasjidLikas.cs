...
public class Loc_MasjidLikas : MonoBehaviour
{
    ...
    public static Loc_MasjidLikas Instance { set; get; }
    public float originalLatitude = 5.996826f;
    public float originalLongitude = 116.106736f;
    public float radius;
