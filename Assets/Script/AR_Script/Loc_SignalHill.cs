...
public class Loc_SignalHill : MonoBehaviour
{
    ...
    public static Loc_SignalHill Instance { set; get; }
    public float originalLatitude = 5.985739f;
    public float originalLongitude = 116.079200f;
    public float radius;
